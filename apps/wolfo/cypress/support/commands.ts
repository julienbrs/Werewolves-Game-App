...
Cypress.Commands.add('getBookmarks', () => {
  cy.intercept('GET','https://cawrest.osc-fr1.scalingo.io/bmt/verninp/bookmarks',).as('getBookmarks');
});

Cypress.Commands.add('postBookmark', () => {
  cy.intercept('POST','https://cawrest.osc-fr1.scalingo.io/bmt/verninp/bookmarks',).as('postBookmark');
});

Cypress.Commands.add('deleteBookmark', () => {
  cy.intercept('DELETE','https://cawrest.osc-fr1.scalingo.io/bmt/verninp/bookmarks/*',).as('deleteBookmark');
});

Cypress.Commands.add('putBookmark', () => {
  cy.intercept('PUT','https://cawrest.osc-fr1.scalingo.io/bmt/verninp/bookmarks/*',).as('putBookmark');
});
